...
- [Node.js SDK repo](https://github.com/fern-covie/covie-node)
- [OpenAPI spec repo](https://github.com/fern-covie/covie-openapi)
...
- Covie's Fern API Definition which lives in the [definition](./fern/api/definition/) folder
